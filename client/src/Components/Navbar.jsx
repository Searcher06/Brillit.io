    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
          ...
          {/* User avatar — opens drawer on mobile, dropdown on desktop */}
          <div className="relative" ref={dropdownRef}>
            <button
              onClick={() => isMobile ? toggleMobileDrawer() : setDropdownOpen((p) => !p)}
            ...
            >
              ...
              {isMobile ? (
                ...
                <>
                  {user?.profilePic ? (
                    <img src={user.profilePic} alt="avatar" className="w-8 h-8 rounded-full object-cover ring-2 ring-violet-500/40" />
                  ) : (
                    <div
