        ...
        <div className="font-[calibri] w-100 pl-5 pr-5 pt-5 pb-5 shadow rounded-xl bg-white">
          <div className="flex items-center justify-between">
            ...
            >
              <FontAwesomeIcon
                icon={faClose}
                className="hover:text-gray-800 text-xl"
              />
            </button>
          </div>
          <div className="flex mt-4 w-full justify-between text-[15px]">
            <div>
              <p
                className="text-sm font-semibold border-b-[1px]
                     border-b-gray-300 h-10 w-30"
              >
                UPLOAD DATE
              </p>
              <div className="text-gray-700">
                <p className="mt-3 hover:text-blue-500 hover:font-semibold">
                  Last year
                </p>
                <p className="mt-3 hover:text-blue-500 hover:font-semibold">
                  This week
