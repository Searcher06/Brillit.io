  ...
  try {
    ...
    if (newFirstName || newLastName) {
      ...
      if (newFirstName?.length > 25)
        throw new Error("Firstname is too long (25 max)");
      if (newLastName?.length > 25)
        throw new Error("Lastname is too long (25 max)");
      if (contains)
        throw new Error("Special characters are not allowed in names");
